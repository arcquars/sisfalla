...
namespace SISFALLA
{
    public partial class CtrlAgentesInvolucrados : UserControl
    {
        ...
        private void EnviarNotificacion()
        {
            ...
            archivosAdjuntos.Add(Path.Combine(Application.StartupPath, "NotificacionEnviar_ag.pdf"));
            archivosAdjuntos.Add(Path.Combine(Application.StartupPath, "NOTIFICACIONFALLA_" + RegFalla.FormatearCodFalla(_regFalla.CodFalla.ToString()) + ".xml.gz"));
