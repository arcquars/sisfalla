...
namespace SISFALLA
{
    public class Inicializador
    {
        public static void Inicializar()
        {
            ...
            AdministradorAyuda.Instance.ProveedorAyuda = new OraDalProveedorAyuda();//new WcfDalSisFalla.WcfClienteProveerdorAyuda();
            
            SincronizadorCliente.Instancia.MgrServidor = new WcfDalSisFalla.WcfClienteSinc();
            
            SincronizadorCliente.Instancia.AdicionarMgr(new Sincronizador_F_QNT_SYNC());
            ...
            SincronizadorCliente.Instancia.AdicionarMgr(new SincronizadorF_AU_OPCIONES());
            SincronizadorCliente.Instancia.AdicionarMgr(new SincronizadorF_AU_ROLES());
            SincronizadorCliente.Instancia.AdicionarMgr(new SincronizadorF_AU_RROL_OPCIONES());
            ...
            SincronizadorCliente.Instancia.AdicionarMgr(new SincronizadorP_GF_CORREOS());
            SincronizadorCliente.Instancia.AdicionarMgr(new SincronizadorF_AC_NODO());
            SincronizadorCliente.Instancia.AdicionarMgr(new SincronizadorF_AC_RCOMPONENTE_NODO());
