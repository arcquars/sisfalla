...
{
    [Serializable]
    public class FormatoLectura : ObjetoDeNegocio
    {
        ...
        public FormatoLectura() { }

        public FormatoLectura(DataRow dataRow)
        {
    ...
    public interface IFormatoLecturaMgr
    {
        void Guardar(FormatoLectura obj);
        DataTable GetTabla();
        BindingList<FormatoLectura> GetLista();
    }
}