...
namespace DifusionInformacion
{
    class Redespacho: Generador
    {
        ...
        public override void SetOperacionPublicacion(DateTime fecha, string motivo)
        {
                ...
                opn.RegistrarOperacionPublicacion(DOMINIOS_OPERACION_PUBLICACION.PUBLICACION_REDESPACHO_DIARIO, UtilesExtraFecha.FormatearRutaArchivo(ConfigPublicacion.formatoNombreArchivo), ConfigPublicacion.idCategoria, fecha, motivo);
