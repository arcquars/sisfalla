...
{
    [Serializable]
    public class DemandaNodoIdentificadorSemana : ObjetoDeNegocio
    {
        public const string NOMBRE_TABLA = "F_DM_DEMANDA_NODO_IDENT_SEMANA";

        public const string C_PK_DEMANDA_NODO_IDENT_SEMANA = "PK_DEMANDA_NODO_IDENT_SEMANA";
        ...
        public long PkDemandaNodoIdentSemana { get; set; }
        public long DCodDiaSemana { get; set; }
        public double Hora1 { get; set; }
        public double Hora2 { get; set; }
        public double Hora3 { get; set; }
        public double Hora4 { get; set; }
        public double Hora5 { get; set; }
        public double Hora6 { get; set; }
        public double Hora7 { get; set; }
        public double Hora8 { get; set; }
        public double Hora9 { get; set; }
        ...
        public DemandaNodoIdentificadorSemana() { }

        public DemandaNodoIdentificadorSemana(DataRow dataRow)
        {
            PkDemandaNodoIdentSemana = GetValor<long>(dataRow[C_PK_DEMANDA_NODO_IDENT_SEMANA]);
            DCodDiaSemana = GetValor<long>(dataRow[C_D_COD_DIA_SEMANA]);
            Hora1 = GetValor<double>(dataRow[C_HORA_1]);
            Hora2 = GetValor<double>(dataRow[C_HORA_2]);
            Hora3 = GetValor<double>(dataRow[C_HORA_3]);
            Hora4 = GetValor<double>(dataRow[C_HORA_4]);
            Hora5 = GetValor<double>(dataRow[C_HORA_5]);
            Hora6 = GetValor<double>(dataRow[C_HORA_6]);
            Hora7 = GetValor<double>(dataRow[C_HORA_7]);
            Hora8 = GetValor<double>(dataRow[C_HORA_8]);
            Hora9 = GetValor<double>(dataRow[C_HORA_9]);
        ...
        {
            dataRow[C_PK_DEMANDA_NODO_IDENT_SEMANA] = PkDemandaNodoIdentSemana;
    ...
    public interface IDemandaNodoIdentificadorSemanaMgr
    {
        void Guardar(DemandaNodoIdentificadorSemana obj);
        DataTable GetTabla();
        BindingList<DemandaNodoIdentificadorSemana> GetLista();
    }
}
