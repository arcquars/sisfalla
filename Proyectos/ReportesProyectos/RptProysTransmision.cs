...
{
    public class RptProysTransmision: ProveedorDatosBase
    {
        public override List<DataTable> GetDatos()
        {
            ...
            string sql =
            @"SELECT f_pr_proyecto_maestro.nombre,f_pr_proyecto_maestro.codigo,f_pr_proyecto_maestro.fecha_registro, 
            d.descripcion_dominio as TipoProyecto 
            ...
            sql = string.Format(sql, (int)D_COD_TIPO_PROYECTO.PROYECTOS_DE_TRANSMISIÓN);
